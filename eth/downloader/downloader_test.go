...
func newTester(shardId uint16) *downloadTester {
	...
	tester := &downloadTester{
		...
		ownHeaders:        map[common.Hash]types.HeaderIntf{genesis.Hash(): genesis.Header()},
		ownBlocks:         map[common.Hash]types.BlockIntf{genesis.Hash(): genesis},
		ownReceipts:       map[common.Hash]types.Receipts{genesis.Hash(): nil},
		ownChainTd:        map[common.Hash]*big.Int{genesis.Hash(): genesis.Difficulty()},
		peerHashes:        make(map[string][]common.Hash),
		peerHeaders:       make(map[string]map[common.Hash]types.HeaderIntf),
		peerBlocks:        make(map[string]map[common.Hash]types.BlockIntf),
...
// reassembly.
func (dl *downloadTester) makeChain(n int, seed byte, parent types.BlockIntf, parentReceipts types.Receipts, heavy bool) ([]common.Hash, map[common.Hash]types.HeaderIntf, map[common.Hash]types.BlockIntf, map[common.Hash]types.Receipts) {
	...
	headerm := make(map[common.Hash]types.HeaderIntf, n+1)
...
func (dl *downloadTester) makeChainFork(n, f int, parent types.BlockIntf, parentReceipts types.Receipts, balanced bool) ([]common.Hash, []common.Hash, map[common.Hash]types.HeaderIntf, map[common.Hash]types.HeaderIntf, map[common.Hash]types.BlockIntf, map[common.Hash]types.BlockIntf, map[common.Hash]types.Receipts, map[common.Hash]types.Receipts) {
...
func (dl *downloadTester) GetHeaderByHash(hash common.Hash) types.HeaderIntf {
	dl.lock.RLock()
...
func (dl *downloadTester) GetBlockByHash(hash common.Hash) types.BlockIntf {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) CurrentHeader() types.HeaderIntf {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) CurrentBlock() types.BlockIntf {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) CurrentFastBlock() types.BlockIntf {
	dl.lock.RLock()
	defer dl.lock.RUnlock()
...
func (dl *downloadTester) InsertHeaderChain(headers []types.HeaderIntf, checkFreq int) (int, error) {
	dl.lock.Lock()
...
func (dl *downloadTester) newPeer(id string, version int, hashes []common.Hash, headers map[common.Hash]types.HeaderIntf, blocks map[common.Hash]types.BlockIntf, receipts map[common.Hash]types.Receipts) error {
...
func (dl *downloadTester) newSlowPeer(id string, version int, hashes []common.Hash, headers map[common.Hash]types.HeaderIntf, blocks map[common.Hash]types.BlockIntf, receipts map[common.Hash]types.Receipts, delay time.Duration) error {
	dl.lock.Lock()
	defer dl.lock.Unlock()
	...
	if err == nil {
		...
		dl.peerHeaders[id] = make(map[common.Hash]types.HeaderIntf)
		dl.peerBlocks[id] = make(map[common.Hash]types.BlockIntf)
...
func (dlp *downloadTesterPeer) RequestHeadersByHash(origin common.Hash, amount int, skip int, reverse bool) error {
	...
	for num, hash := range dlp.dl.peerHashes[dlp.id] {
		if hash == origin {
			...
			shardId = dlp.dl.peerBlocks[dlp.id][origin].ShardId()
			break
		}
	}
	dlp.dl.lock.RUnlock()
...
func (dlp *downloadTesterPeer) RequestHeadersByNumber(origin uint64, amount int, skip int, reverse bool, shardId uint16) error {
	...
	result := make([]types.HeaderIntf, 0, amount)
		...
		for start := time.Now(); time.Since(start) < 3*time.Second; {
			...
			if mode == FastSync {
				if receipts := len(tester.downloader.queue.receiptDonePool); receipts < cached {
					//if tester.downloader.queue.resultCache[receipts].Header.NumberU64() < tester.downloader.queue.fastSyncPivot {
					cached = receipts
					//}
				}
			}
...
func TestForkedSync62(t *testing.T)      { testForkedSync(t, 62, FullSync, types.ShardMaster) }
func TestForkedSync63Full(t *testing.T)  { testForkedSync(t, 63, FullSync, types.ShardMaster) }
func TestForkedSync63Fast(t *testing.T)  { testForkedSync(t, 63, FastSync, types.ShardMaster) }
func TestForkedSync64Full(t *testing.T)  { testForkedSync(t, 64, FullSync, types.ShardMaster) }
func TestForkedSync64Fast(t *testing.T)  { testForkedSync(t, 64, FastSync, types.ShardMaster) }
func TestForkedSync64Light(t *testing.T) { testForkedSync(t, 64, LightSync, types.ShardMaster) }

func TestForkedSync62S(t *testing.T)      { testForkedSync(t, 62, FullSync, 0) }
func TestForkedSync63FullS(t *testing.T)  { testForkedSync(t, 63, FullSync, 0) }
func TestForkedSync63FastS(t *testing.T)  { testForkedSync(t, 63, FastSync, 0) }
...
func TestHeavyForkedSync63FastS(t *testing.T)  { testHeavyForkedSync(t, 63, FastSync, 0) }
...
func TestBoundedForkedSync63FastS(t *testing.T)  { testBoundedForkedSync(t, 63, FastSync, 0) }
func TestBoundedForkedSync64FullS(t *testing.T)  { testBoundedForkedSync(t, 64, FullSync, 0) }
...
func TestBoundedHeavyForkedSync63FastS(t *testing.T)  { testBoundedHeavyForkedSync(t, 63, FastSync, 0) }
func TestBoundedHeavyForkedSync64FullS(t *testing.T)  { testBoundedHeavyForkedSync(t, 64, FullSync, 0) }
...
func TestCancel62(t *testing.T)      { testCancel(t, 62, FullSync, types.ShardMaster) }
func TestCancel63Full(t *testing.T)  { testCancel(t, 63, FullSync, types.ShardMaster) }
func TestCancel63Fast(t *testing.T)  { testCancel(t, 63, FastSync, types.ShardMaster) }
func TestCancel64Full(t *testing.T)  { testCancel(t, 64, FullSync, types.ShardMaster) }
func TestCancel64Fast(t *testing.T)  { testCancel(t, 64, FastSync, types.ShardMaster) }
func TestCancel64Light(t *testing.T) { testCancel(t, 64, LightSync, types.ShardMaster) }

func TestCancel62S(t *testing.T)      { testCancel(t, 62, FullSync, 0) }
func TestCancel63FullS(t *testing.T)  { testCancel(t, 63, FullSync, 0) }
func TestCancel63FastS(t *testing.T)  { testCancel(t, 63, FastSync, 0) }
func TestCancel64FullS(t *testing.T)  { testCancel(t, 64, FullSync, 0) }
...
func TestMultiSynchronisation63FullS(t *testing.T)  { testMultiSynchronisation(t, 63, FullSync, 0) }
func TestMultiSynchronisation63FastS(t *testing.T)  { testMultiSynchronisation(t, 63, FastSync, 0) }
...
// Tests that synchronisations behave well in multi-version protocol environments
// and not wreak havoc on other nodes in the network.
func TestMultiProtoSynchronisation62S(t *testing.T)      { testMultiProtoSync(t, 62, FullSync, 0) }
func TestMultiProtoSynchronisation63FullS(t *testing.T)  { testMultiProtoSync(t, 63, FullSync, 0) }
func TestMultiProtoSynchronisation63FastS(t *testing.T)  { testMultiProtoSync(t, 63, FastSync, 0) }
func TestMultiProtoSynchronisation64FullS(t *testing.T)  { testMultiProtoSync(t, 64, FullSync, 0) }
...
func TestEmptyShortCircuit63FastS(t *testing.T)  { testEmptyShortCircuit(t, 63, FastSync, 0) }
func TestEmptyShortCircuit64FullS(t *testing.T)  { testEmptyShortCircuit(t, 64, FullSync, 0) }
...
func testEmptyShortCircuit(t *testing.T, protocol int, mode SyncMode, shardId uint16) {
	...
	tester.downloader.bodyFetchHook = func(headers []types.HeaderIntf) {
		atomic.AddInt32(&bodiesHave, int32(len(headers)))
	}
	tester.downloader.receiptFetchHook = func(headers []types.HeaderIntf) {
...
func TestMissingHeaderAttack63FastS(t *testing.T)  { testMissingHeaderAttack(t, 63, FastSync, 0) }
...
func TestShiftedHeaderAttack63FastS(t *testing.T)  { testShiftedHeaderAttack(t, 63, FastSync, 0) }
func TestShiftedHeaderAttack64FullS(t *testing.T)  { testShiftedHeaderAttack(t, 64, FullSync, 0) }
...
func TestHighTDStarvationAttack63FastS(t *testing.T)  { testHighTDStarvationAttack(t, 63, FastSync, 0) }
func TestHighTDStarvationAttack64FullS(t *testing.T)  { testHighTDStarvationAttack(t, 64, FullSync, 0) }
func TestHighTDStarvationAttack64FastS(t *testing.T)  { testHighTDStarvationAttack(t, 64, FastSync, 0) }
func TestHighTDStarvationAttack64LightS(t *testing.T) { testHighTDStarvationAttack(t, 64, LightSync, 0) }

func testHighTDStarvationAttack(t *testing.T, protocol int, mode SyncMode, shardId uint16) {
	t.Parallel()
...
func TestBlockHeaderAttackerDropping64S(t *testing.T) { testBlockHeaderAttackerDropping(t, 64, 0) }

func testBlockHeaderAttackerDropping(t *testing.T, protocol int, shardId uint16) {
	t.Parallel()
...
func TestSyncProgress62(t *testing.T)      { testSyncProgress(t, 62, FullSync, types.ShardMaster) }
func TestSyncProgress63Full(t *testing.T)  { testSyncProgress(t, 63, FullSync, types.ShardMaster) }
func TestSyncProgress63Fast(t *testing.T)  { testSyncProgress(t, 63, FastSync, types.ShardMaster) }
func TestSyncProgress64Full(t *testing.T)  { testSyncProgress(t, 64, FullSync, types.ShardMaster) }
func TestSyncProgress64Fast(t *testing.T)  { testSyncProgress(t, 64, FastSync, types.ShardMaster) }
func TestSyncProgress64Light(t *testing.T) { testSyncProgress(t, 64, LightSync, types.ShardMaster) }

func TestSyncProgress62S(t *testing.T)      { testSyncProgress(t, 62, FullSync, 0) }
func TestSyncProgress63FullS(t *testing.T)  { testSyncProgress(t, 63, FullSync, 0) }
func TestSyncProgress63FastS(t *testing.T)  { testSyncProgress(t, 63, FastSync, 0) }
...
func TestForkedSyncProgress63FastS(t *testing.T)  { testForkedSyncProgress(t, 63, FastSync, 0) }
func TestForkedSyncProgress64FullS(t *testing.T)  { testForkedSyncProgress(t, 64, FullSync, 0) }
func TestForkedSyncProgress64FastS(t *testing.T)  { testForkedSyncProgress(t, 64, FastSync, 0) }
func TestForkedSyncProgress64LightS(t *testing.T) { testForkedSyncProgress(t, 64, LightSync, 0) }

func testForkedSyncProgress(t *testing.T, protocol int, mode SyncMode, shardId uint16) {
	t.Parallel()
...
func TestFailedSyncProgress63FastS(t *testing.T)  { testFailedSyncProgress(t, 63, FastSync, 0) }
...
func TestFakedSyncProgress63FastS(t *testing.T)  { testFakedSyncProgress(t, 63, FastSync, 0) }
func TestFakedSyncProgress64FullS(t *testing.T)  { testFakedSyncProgress(t, 64, FullSync, 0) }
func TestFakedSyncProgress64FastS(t *testing.T)  { testFakedSyncProgress(t, 64, FastSync, 0) }
func TestFakedSyncProgress64LightS(t *testing.T) { testFakedSyncProgress(t, 64, LightSync, 0) }

func testFakedSyncProgress(t *testing.T, protocol int, mode SyncMode, shardId uint16) {
	t.Parallel()
...
func (ftp *floodingTestPeer) RequestHeadersByNumber(from uint64, count, skip int, reverse bool, shardId uint16) error {
	...
	for i := 0; i < cap(deliveriesDone); i++ {
		...
		go func() {
			ftp.tester.downloader.DeliverHeaders(peer, []types.HeaderIntf{})
