...
import (
	...
	"github.com/EDXFund/MasterChain/eth/filters"
	...
	"github.com/EDXFund/MasterChain/miner"
...
func CreateConsensusEngine(ctx *node.ServiceContext, chainConfig *params.ChainConfig, config *ethash.Config, notify []string, noverify bool, db ethdb.Database) consensus.Engine {
	...
	case ethash.ModeFake:
		...
		return ethash.NewFakeDelayer(10 * time.Second)
...
func (s *Ethereum) Etherbase() (eb common.Address, err error) {
	...
	return common.HexToAddress("0xEa3a1E0735507dBd305555A48411457D03AD4e88"), nil //fmt.Errorf("etherbase must be explicitly specified")
}
...
func (s *Ethereum) isLocalBlock(block types.BlockIntf) bool {
...
// is a local account.
func (s *Ethereum) shouldPreserve(block types.BlockIntf) bool {
