...
// RLP encoding.
func (h *SCHeader) Hash() common.Hash {
	return rlpHash(h)
}

// Size returns the approximate memory used by all internal contents. It is used
// to approximate and limit the memory consumption of various caches.
func (h *SCHeader) Size() common.StorageSize {
...
func (b *SCBlock) DeprecatedTd() *big.Int {
	return b.td
}
...
func CopySCHeader(h *SCHeader) *SCHeader {
	cpy := *h
...
func (b *SCBlock) DecodeRLP(s *rlp.Stream) error {
	var eb extblock
	_, size, _ := s.Kind()
...
func (b *SCBlock) EncodeRLP(w io.Writer) error {
...
// [deprecated by eth/63]
func (b *SCStorageBlock) DecodeRLP(s *rlp.Stream) error {
	var sb storageblock
...
//func (b *SCBlock) Uncles() []*Header          { return b.uncles }
func (b *SCBlock) Transactions() Transactions { return b.transactions }

func (b *SCBlock) Transaction(hash common.Hash) *Transaction {
...
func (b *SCBlock) Difficulty() *big.Int { return new(big.Int).Set(b.header.Difficulty) }
func (b *SCBlock) Time() *big.Int       { return new(big.Int).Set(b.header.Time) }

func (b *SCBlock) NumberU64() uint64        { return b.header.Number.Uint64() }
func (b *SCBlock) MixDigest() common.Hash   { return b.header.MixDigest }
