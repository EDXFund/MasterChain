...
var _ = (*scheaderMarshaling)(nil)

func (h SCHeader) MarshalJSON() ([]byte, error) {
	type Header struct {
...
func (h *SCHeader) UnmarshalJSON(input []byte) error {
	type Header struct {
		ShardId		uint16		   `json:"shardId"			gencodec:"required"`
		ParentHash  *common.Hash    `json:"parentHash"       gencodec:"required"`
		Coinbase    *common.Address `json:"miner"            gencodec:"required"`
...
func (h MCHeader) MarshalJSON() ([]byte, error) {
	type Header struct {
		ShardId		uint16		   `json:"shardId"			gencodec:"required"`
		ParentHash  common.Hash    `json:"parentHash"       gencodec:"required"`
...
func (h *MCHeader) UnmarshalJSON(input []byte) error {
	type Header struct {
		ShardId		uint16		   `json:"shardId"			gencodec:"required"`
		ParentHash  *common.Hash    `json:"parentHash"       gencodec:"required"`
		//hash of most lasted blocks of shards
