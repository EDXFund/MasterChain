...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/EDXFund/MasterChain

    go install github.com/EDXFund/MasterChain/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/EDXFund/MasterChain`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/EDXFund/MasterChain
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/EDXFund/MasterChain/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/EDXFund/MasterChain/wiki/Code-Review-Guidelines).
